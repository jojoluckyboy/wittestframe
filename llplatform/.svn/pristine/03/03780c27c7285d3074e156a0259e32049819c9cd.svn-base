...
//			System.out.println(NewTestCase.class.getClassLoader().getResource("config.properties").getPath());
			...
			String url = PropertiesUtil.getTestResourceValue(configPath, "url");

//			String url = "http://115.238.48.66:1183/client/log/add";

//			String xmlPath = System.getProperty("user.dir") + "\\src\\test\\resource\\LogAdd.xml";
			 
		      /*	获取test/resouce目录下的测试数据xml的值	*/
			String xmlPath =getClass().getResource("/LogAdd.xml").getPath();			 
